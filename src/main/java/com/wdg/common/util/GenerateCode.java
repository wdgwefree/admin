...
public class GenerateCode {
    ...
    public static void main(String[] args) {
        ...
        FastAutoGenerator.create("jdbc:mysql://192.168.0.200:3306/dcsm_wf_test?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8", "root", "root")
                ...
                .strategyConfig(builder -> {
                    builder.addInclude("cert") // 设置需要生成的表名
